...
export const SettingsPage: React.FC = observer(() => {
    ...
    return (
        <div className="flex items-center justify-center h-screen selection:bg-text selection:text-bg text-3xl">
            <div className="grid grid-cols-2 gap-x-2 gap-y-10">
                <span className='mr-default font-semibold'>Difficulty:</span>
                <LevelRange level={level} dynamic={true} size={LevelRangeSize.Large} onClick={setLevel}></LevelRange>
