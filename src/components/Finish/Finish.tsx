...
export const Finish: React.FC<IFinish> = ({ moves, onPlayClick, onQuitClick }) => {
    return (
        <div className='flex flex-col h-screen w-screen items-center justify-center text-3xl selection:bg-text selection:text-bg'>
            <div>Woo-hoo! Congratulations!</div>
            <div>You won in <span className='font-bold'>{moves}</span> moves</div>
