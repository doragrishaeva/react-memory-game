...
export class GameStore {
    ...
    private checkPair(card: ICard) {
        ...
        const state = this.selectedCard.pairId === card.pairId ? CardState.Done : CardState.Initial;
    ...
    private checkFinish() {
        const undoneCards = this.cards.filter((card: ICard) => card.state !== CardState.Done);
